...
import { GROQ_MODEL_FAST } from '../../lib/groq'
...
Réponds UNIQUEMENT avec le mnémonique, sans introduction ni explication.`
  ...
  try {
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({ model: GROQ_MODEL_FAST, messages: [{ role: 'user', content: prompt }], temperature: 0.7, max_tokens: 500, reasoning_effort: 'low', reasoning_format: 'hidden' })
    })

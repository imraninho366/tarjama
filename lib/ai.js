 ...
 *
 * Ordre retenu (débit décroissant, réservoirs à la fin). Les chiffres Mistral
 * sont relevés sur https://admin.mistral.ai/plateforme/limits, pas estimés :
 *
 *   mistral    — 60 req/min, 20 K tokens/min, ~1 Md tokens/MOIS. Le meilleur
 *                des deux mondes : 2,5x le débit en tokens de Groq ET de loin
 *                le plus gros réservoir. Boîte française, donc excellent sur le
 *                français, la langue de toute l'interface.
...
const PROVIDERS = [
  {
    ...
    // Version datée et NON l'alias « mistral-small-latest » : cet alias ne
    // figure pas dans les modèles accordés au compte, et Mistral le rejette
    // par un 429 trompeur (« Rate limit exceeded ») au lieu d'un 404. Deux
    // heures de diagnostic ont été perdues à chercher un quota inexistant.
    //
    // La liste des modèles réellement accordés, avec leurs limites exactes,
    // est sur https://admin.mistral.ai/plateforme/limits — c'est elle qui
    // fait foi, pas la documentation publique.
